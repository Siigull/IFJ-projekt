...
void print_token(Token* token, FILE* out) {
    switch (token->type) {
        case T_ID:          fprintf(out, "T_ID");          break;
        case T_F64:         fprintf(out, "T_F64");         break;
        case T_I32:         fprintf(out, "T_I32");         break;
        case T_U8:          fprintf(out, "T_U8");          break;
        case T_DOT:         fprintf(out, "T_DOT");         break;
        case T_QUOTATION:   fprintf(out, "T_QUOTATION");   break;
        case T_QUESTMARK:   fprintf(out, "T_QUESTMARK");   break;
        case T_EXCLEMARK:   fprintf(out, "T_EXCLEMARK");   break;
        case T_EXPONENT:    fprintf(out, "T_EXPONENT");    break;
        case T_STRING:      fprintf(out, "T_STRING");      break;
        case T_COMMENT:     fprintf(out, "T_COMMENT");     break;
        case T_RPAR:        fprintf(out, "T_RPAR");        break;
        case T_LPAR:        fprintf(out, "T_LPAR");        break;
        case T_SQRBRACKET:  fprintf(out, "T_SQRBRACKET");  break;
        case T_SQLBRACKET:  fprintf(out, "T_SQLBRACKET");  break;
        case T_CUYRBRACKET: fprintf(out, "T_CUYRBRACKET"); break;
        case T_CUYLBRACKET: fprintf(out, "T_CUYLBRACKET"); break;
        case T_CONST:       fprintf(out, "T_CONST");       break;
        case T_IF:          fprintf(out, "T_IF");          break;
        case T_ELSE:        fprintf(out, "T_ELSE");        break;
        case T_FN:          fprintf(out, "T_FN");          break;
        case T_PUB:         fprintf(out, "T_PUB");         break;
        case T_RETURN:      fprintf(out, "T_RETURN");      break;
        case T_VAR:         fprintf(out, "T_VAR");         break;
        case T_VOID:        fprintf(out, "T_VOID");        break;
        case T_WHILE:       fprintf(out, "T_WHILE");       break;
        case T_IMPORT:      fprintf(out, "T_IMPORT");      break;
        case T_SEMI:        fprintf(out, "T_SEMI");        break;
        case T_DDOT:        fprintf(out, "T_DDOT");        break;
        case T_PLUS:        fprintf(out, "T_PLUS");        break;
        case T_MINUS:       fprintf(out, "T_MINUS");       break;
        case T_MUL:         fprintf(out, "T_MUL");         break;
        case T_DIV:         fprintf(out, "T_DIV");         break;
        case T_EQUAL:       fprintf(out, "T_EQUAL");       break;
        case T_NEQUAL:      fprintf(out, "T_NEQUAL");      break;
        case T_GTHAN:       fprintf(out, "T_GTHAN");       break;
        case T_GETHAN:      fprintf(out, "T_GETHAN");      break;
        case T_STHAN:       fprintf(out, "T_STHAN");       break;
        case T_SETHAN:      fprintf(out, "T_SETHAN");      break;
        case T_OPERATOR:    fprintf(out, "T_OPERATOR");    break;
        case T_UNDEF:       fprintf(out, "T_UNDEF");       break;
        case T_NULL:        fprintf(out, "T_NULL");        break;
        case T_EOF:         fprintf(out, "T_EOF");         break;
        case T_ERR:         fprintf(out, "T_ERR");         break;
        default:            fprintf(out, "Unknown token"); break;
    }
}
