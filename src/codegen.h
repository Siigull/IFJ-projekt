...
/**
 * @brief macro that states start of a program generated by this generator
 * essentially creates the header, defines needed global variables
 * for return values, evaluating conditions and results of expressions
 * and jumps to main function
 * 
 */
...
/**
 * @brief defines program end - used at the end of main function
 * 
 */
