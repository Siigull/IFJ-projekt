...
void parse(char* orig_input) {
    ...
    Token token_arr[] = {{T_DIV, "/", 1},{T_DIV, "/", 1},{T_ID, "Program", 7},
                        {T_I32, "2", 1},{T_DDOT, ":", 1},{T_ID, "Vypocet", 7},
                        {T_ID, "faktorialu", 10},{T_RPAR, "(", 1},{T_ID, "rekurzivne", 10},
                        {T_LPAR, ")", 1},{T_CONST, "const", 5},{T_ID, "ifj", 3},
                        {T_EQUAL, "=", 1},{T_IMPORT, "@import", 7},{T_RPAR, "(", 1},
                        {T_STRING, "ifj24.zig", 9},{T_LPAR, ")", 1},{T_SEMI, ";", 1},
                        {T_PUB, "pub", 3},{T_FN, "fn", 2},{T_ID, "main", 4},
                        {T_RPAR, "(", 1},{T_LPAR, ")", 1},{T_VOID, "void", 4},
                        {T_CUYRBRACKET, "{", 1},{T_BUILDIN, "ifj.write", 9},{T_RPAR, "(", 1},
                        {T_STRING, "Zadejte cislo pro vypocet faktorialu: ", 38},{T_LPAR, ")", 1},{T_SEMI, ";", 1},
                        {T_CONST, "const", 5},{T_ID, "inp", 3},{T_EQUAL, "=", 1},
                        {T_BUILDIN, "ifj.readi32", 11},{T_RPAR, "(", 1},{T_LPAR, ")", 1},
                        {T_SEMI, ";", 1},{T_IF, "if", 2},{T_RPAR, "(", 1},
                        {T_ID, "inp", 3},{T_LPAR, ")", 1},{T_BAR, "|", 1},
                        {T_ID, "INP", 3},{T_BAR, "|", 1},{T_CUYRBRACKET, "{", 1},
                        {T_IF, "if", 2},{T_RPAR, "(", 1},{T_ID, "INP", 3},
                        {T_STHAN, "<", 1},{T_I32, "0", 1},{T_LPAR, ")", 1},
                        {T_CUYRBRACKET, "{", 1},{T_BUILDIN, "ifj.write", 9},{T_RPAR, "(", 1},
                        {T_STRING, "Faktorial nelze spocitat!\n", 27},{T_LPAR, ")", 1},{T_SEMI, ";", 1},
                        {T_CUYLBRACKET, "}", 1},{T_ELSE, "else", 4},{T_CUYRBRACKET, "{", 1},
                        {T_CONST, "const", 5},{T_ID, "vysl", 4},{T_EQUAL, "=", 1},
                        {T_ID, "factorial", 9},{T_RPAR, "(", 1},{T_ID, "INP", 3},
                        {T_LPAR, ")", 1},{T_SEMI, ";", 1},{T_BUILDIN, "ifj.write", 9},
                        {T_RPAR, "(", 1},{T_STRING, "Vysledek: ", 10},{T_LPAR, ")", 1},
                        {T_SEMI, ";", 1},{T_BUILDIN, "ifj.write", 9},{T_RPAR, "(", 1},
                        {T_ID, "vysl", 4},{T_LPAR, ")", 1},{T_SEMI, ";", 1},
                        {T_CUYLBRACKET, "}", 1},{T_CUYLBRACKET, "}", 1},{T_ELSE, "else", 4},
                        {T_CUYRBRACKET, "{", 1},{T_BUILDIN, "ifj.write", 9},{T_RPAR, "(", 1},
                        {T_STRING, "Chyba pri nacitani celeho cisla!\n", 34},{T_LPAR, ")", 1},{T_SEMI, ";", 1},
                        {T_CUYLBRACKET, "}", 1},{T_CUYLBRACKET, "}", 1},{T_PUB, "pub", 3},
                        {T_FN, "fn", 2},{T_ID, "decrement", 9},{T_RPAR, "(", 1},
                        {T_ID, "n", 1},{T_DDOT, ":", 1},{T_DTYPE, "i32", 3},
                        {T_COMMA, ",", 1},{T_ID, "m", 1},{T_DDOT, ":", 1},
                        {T_DTYPE, "i32", 3},{T_LPAR, ")", 1},{T_DTYPE, "i32", 3},
                        {T_CUYRBRACKET, "{", 1},{T_RETURN, "return", 6},{T_ID, "n", 1},
                        {T_MINUS, "-", 1},{T_ID, "m", 1},{T_SEMI, ";", 1},
                        {T_CUYLBRACKET, "}", 1},{T_PUB, "pub", 3},{T_FN, "fn", 2},
                        {T_ID, "factorial", 9},{T_RPAR, "(", 1},{T_ID, "n", 1},
                        {T_DDOT, ":", 1},{T_DTYPE, "i32", 3},{T_LPAR, ")", 1},
                        {T_DTYPE, "i32", 3},{T_CUYRBRACKET, "{", 1},{T_VAR, "var", 3},
                        {T_ID, "result", 6},{T_DDOT, ":", 1},{T_DTYPE, "i32", 3},
                        {T_EQUAL, "=", 1},{T_I32, "0", 1},{T_MINUS, "-", 1},
                        {T_I32, "1", 1},{T_SEMI, ";", 1},{T_IF, "if", 2},
                        {T_RPAR, "(", 1},{T_ID, "n", 1},{T_STHAN, "<", 1},
                        {T_I32, "2", 1},{T_LPAR, ")", 1},{T_CUYRBRACKET, "{", 1},
                        {T_ID, "result", 6},{T_EQUAL, "=", 1},{T_I32, "1", 1},
                        {T_SEMI, ";", 1},{T_CUYLBRACKET, "}", 1},{T_ELSE, "else", 4},
                        {T_CUYRBRACKET, "{", 1},{T_CONST, "const", 5},{T_ID, "decremented_n", 13},
                        {T_EQUAL, "=", 1},{T_ID, "decrement", 9},{T_RPAR, "(", 1},
                        {T_ID, "n", 1},{T_COMMA, ",", 1},{T_I32, "1", 1},
                        {T_LPAR, ")", 1},{T_SEMI, ";", 1},{T_CONST, "const", 5},
                        {T_ID, "temp_result", 11},{T_EQUAL, "=", 1},{T_ID, "factorial", 9},
                        {T_RPAR, "(", 1},{T_ID, "decremented_n", 13},{T_LPAR, ")", 1},
                        {T_SEMI, ";", 1},{T_ID, "result", 6},{T_EQUAL, "=", 1},
                        {T_ID, "n", 1},{T_MUL, "*", 1},{T_ID, "temp_result", 11},
                        {T_SEMI, ";", 1},{T_CUYLBRACKET, "}", 1},{T_RETURN, "return", 6},
                        {T_ID, "result", 6},{T_SEMI, ";", 1},{T_CUYLBRACKET, "}", 1},
                        {T_EOF, "0", 0}};
