...
TESTDIR=
COMPILER=./../bin/app      # Path to the compiler binary
INTERPRETER=./../ic24int   # Path to the interpreter binary
path_in=in       # Input directory containing .ifj and .in* files
path_out=out      # Output directory for generated files
path_ref=ref     # Reference direcotry for .ref* and .exit* files
